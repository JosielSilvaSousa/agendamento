...
import { IUserRepository, IUserRepositoryToken } from 'src/repository/interface/user.repository.interface';
...
export class UserService extends BaseService<UserEntity> implements IUserService {
  ...
  public async findOneByOrFail(where: FindOptionsWhere<UserEntity> | FindOptionsWhere<UserEntity>[]): Promise<UserEntity> {
